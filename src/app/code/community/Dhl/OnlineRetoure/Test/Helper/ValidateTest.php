...
class Dhl_OnlineRetoure_Test_Helper_ValidateTest extends EcomDev_PHPUnit_Test_Case
{
    ...
    {
        $this->store->setConfig('shipping/dhlonlineretoure/allowed_countries', 'FR,NL,AT,PL,HU,GB');
    ...
    {
        $this->store->setConfig('shipping/dhlonlineretoure/active', '1');
        ...
        $this->store->setConfig('shipping/dhlonlineretoure/allowed_shipping_methods', "flatrate_flatrate");
