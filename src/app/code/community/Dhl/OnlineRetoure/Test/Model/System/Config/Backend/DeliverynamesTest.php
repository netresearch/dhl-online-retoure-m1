...
class Dhl_OnlineRetoure_Test_Model_System_Config_Backend_DeliverynamesTest extends EcomDev_PHPUnit_Test_Case
{
    public function testUniqueCountry()
    {
        ...
        /** @var Dhl_OnlineRetoure_Model_System_Config_Backend_Deliverynames $backendModel */
        ...
        $this->setExpectedException(
            'Mage_Core_Exception',
            'Country in area Online Return must not be defined twice.'
        );
        $method->invoke($backendModel);
    }
    ...
    public function testAllowedCountry()
    {
        ...
        $allowedCountries = 'DE,FR,NL,AT,PL,HU,GB';
        $store->setConfig('shipping/dhlonlineretoure/allowed_countries', $allowedCountries);
        ...
        $exceptionMessage = sprintf('Selected country "%s" is not applicable for online return.', $deliveryIsoCH);
