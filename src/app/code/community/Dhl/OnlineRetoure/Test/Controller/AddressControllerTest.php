    ...
    extends EcomDev_PHPUnit_Test_Case_Controller
{
    ...
    public function testConfirmAction()
    {
        ...
        $validateHelper = $this->getHelperMock(
            'dhlonlineretoure/validate',
            array('isHashRequest', 'isInternalRequest', 'isOrderValid', 'isCustomerValid', 'isOrderIdValid')
        );
        ...
        $validateHelper->expects($this->any())
                       ...
                       ->will(
                           $this->onConsecutiveCalls(
                               ...
                               $this->throwException(new Dhl_OnlineRetoure_Model_Validate_Exception())
                           )
                       );
        ...
        $this->assertLayoutBlockTypeOf(
            'dhlonlineretoure_customer_address_edit',
            'dhlonlineretoure/customer_address_edit'
        );
    ...
    public function testFormPostAction()
    {
        ...
        $validateHelper = $this->getHelperMock(
            'dhlonlineretoure/validate',
            array('isHashRequest', 'isInternalRequest', 'isOrderValid', 'isCustomerValid')
        );
        $validateHelper->expects($this->any())
                       ->method('isHashRequest')
                       ->will($this->returnValue(false));
